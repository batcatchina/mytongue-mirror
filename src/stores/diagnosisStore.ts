...
interface DiagnosisState {
  ...
  setTongueState: (state: string, degree?: string) => void;
    ...
    (set, get) => ({
      ...
      setTongueShape: (shape, confidence) =>
        set((state) => ({
          inputFeatures: {
            ...state.inputFeatures,
            tongueShape: { value: shape, confidence },
          },
        })),
      ...
      setTongueState: (stateValue, degree) =>
        set((state) => ({
          inputFeatures: {
            ...state.inputFeatures,
            tongueState: { value: stateValue, degree: degree as any },
          },
        })),
      ...
      getDiagnosisInput: () => {
        ...
        return {
          ...
          options: {
            ...
            includeTreatmentAdvice: true,
            personalization: '标准',
            acupuncturePointCount: 5,
          },
        };
      },
      ...
      saveCase: (result) => {
        ...
        set((state) => ({
          caseList: [caseRecord, ...state.caseList],
        }));
      },
