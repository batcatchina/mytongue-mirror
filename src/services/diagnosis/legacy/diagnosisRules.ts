...
export interface TongueFeatures {
  ...
  coatingMoisture: string;    // 润燥: 润/燥/正常
  tongueState: string;        // 舌态: 强硬/痿软/歪斜/颤动/正常
  teethMark: boolean;         // 齿痕
  crack: boolean;             // 裂纹
  regionFeatures?: {          // 分区特征
    region: string;            // 舌尖/舌边/舌中/舌根
    color?: string;            // 该区域舌色
    features?: string[];       // 该区域特征
  }[];
}
...
export interface DiagnosisRule {
  ...
  conditions: {
    ...
    teethMark?: boolean;
    crack?: boolean;
    regionFeatures?: { region: string; color?: string; features?: string[] }[];
  };
  result: {
    syndrome: string;
    pathogenesis: string;
...
export interface AcupointSelection {
  ...
  huiPoint?: string;
  xiPoint?: string;
  method: AcupunctureMethod;
}

export interface AcupunctureMethod {
  technique: '补法' | '泻法' | '平补平泻';
  needleRetention: number;  // 留针时间（分钟）
  moxibustion: string;
  frequency: string;
  course: string;
  notes: string;
...
// 2.1 舌色辨证规则表（6条）
export const tongueColorRules: DiagnosisRule[] = [
  {
    id: 'TC-001',
    name: '淡红舌辨证',
...
// 2.2 舌色分布辨证规则（6条）
export const tongueColorDistributionRules: DiagnosisRule[] = [
  {
    id: 'TCD-001',
    name: '舌尖红辨证',
    conditions: { 
...
// 2.3 舌形辨证规则表（7条）
export const tongueShapeRules: DiagnosisRule[] = [
  {
    id: 'TS-001',
    name: '胖大舌辨证',
...
// 2.4 苔色辨证规则表（8条）
export const coatingColorRules: DiagnosisRule[] = [
  {
    id: 'CC-001',
    name: '薄白苔辨证',
...
// 2.5 苔质辨证规则表（7条）
export const coatingTextureRules: DiagnosisRule[] = [
  {
    id: 'CT-001',
    name: '薄苔辨证',
...
// 2.6 舌态辨证规则表（6条）
export const tongueStateRules: DiagnosisRule[] = [
  {
    id: 'TST-001',
    name: '颤动舌辨证',
...
// 3.1 舌质+舌苔复合辨证（15条）
export const tongueBodyCoatingRules: DiagnosisRule[] = [
  {
    id: 'TBC-001',
    name: '淡白舌+白苔',
...
// 3.2 舌形+舌苔复合辨证（8条）
export const tongueShapeCoatingRules: DiagnosisRule[] = [
  {
    id: 'TSC-001',
    name: '胖大舌+齿痕+白腻苔',
...
// 3.3 舌态+舌质复合辨证（8条）
export const tongueStateBodyRules: DiagnosisRule[] = [
  {
    id: 'TSB-001',
    name: '颤动舌+淡白',
...
export const threeDimensionalRules: DiagnosisRule[] = [
  {
    id: '3D-001',
    name: '淡白胖大+白腻苔综合辨证',
...
export const huiXiRules: HuiXiRule[] = [
...
export interface SpecialAcupointRule {
  tongueType: string;
  acupoints: string[];
  effect: string;
  application: string;
...
export const specialAcupointRules: SpecialAcupointRule[] = [
...
export interface RegionAcupointRule {
  region: string;
  feature: string;
  organ: string;
  acupoints: string[];
...
export const regionAcupointRules: RegionAcupointRule[] = [
...
export const allRuleCategories = {
...
export const getTotalRuleCount = (): number => {
